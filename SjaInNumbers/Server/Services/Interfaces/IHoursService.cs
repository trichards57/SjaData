...
public interface IHoursService
{
    ...
    /// </returns>
    Task<HoursCount> CountAsync(DateOnly date, DateType dateType, bool future, string etag);
    ...
    /// </returns>
    Task<HoursTarget> GetNhseTargetAsync();
    ...
    /// </returns>
    Task<Trends> GetTrendsAsync(Region region, bool nhse, string etag);
