...
public partial class HoursController(IHoursService hoursService, ILogger<HoursController> logger) : ControllerBase
{
        ...
        [FromQuery(Name = "future")] bool future = false)
    {
        ...
        {
            LogItemNotModified("Hours count", actualEtag);
        ...
        LogItemFound("Hours count", count.LastUpdate, actualEtag);
    ...
    [RevalidateCache]
    public async Task<IActionResult> GetTrends([FromHeader(Name = "If-None-Match")] string? etag, [ModelBinder<RegionBinder>] Region region, bool nhse = false)
    {
