        ...
        group.MapGet("count", GetPatientCount)
            ...
            .WithOpenApi(o =>
            {
                ...
                o.Responses[StatusCodes.Status200OK.ToString()].Content["application/json"].Example = new OpenApiObject()
                {
                    ...
                    {
                        ["NorthEast"] = new OpenApiInteger(42),
                        ["LondonAmbulanceService"] = new OpenApiInteger(21),
                    },
                ...
                o.Parameters.Add(new() { Name = "region", In = ParameterLocation.Query, Schema = new() { Type = "string", Enum = [new OpenApiString("NorthEast"), new OpenApiString("NorthWest"), new OpenApiString("WestMidlands"), new OpenApiString("EastMidlands"), new OpenApiString("EastOfEngland"), new OpenApiString("London"), new OpenApiString("SouthEast"), new OpenApiString("SouthWest")] }, Required = false, Description = "The type of region to filter by.", });
                o.Parameters.Add(new() { Name = "trust", In = ParameterLocation.Query, Schema = new() { Type = "string", Enum = [new OpenApiString("NorthEastAmbulanceService"), new OpenApiString("NorthWestAmbulanceService"), new OpenApiString("WestMidlandsAmbulanceService"), new OpenApiString("EastMidlandsAmbulanceService"), new OpenApiString("EastOfEnglandAmbulanceService"), new OpenApiString("LondonAmbulanceService"), new OpenApiString("SouthEastCoastAmbulanceService"), new OpenApiString("SouthWesternAmbulanceService"), new OpenApiString("SouthCentralAmbulanceService"), new OpenApiString("YorkshireAmbulanceService"), new OpenApiString("WelshAmbulanceService"), new OpenApiString("ScottishAmbulanceService"), new OpenApiString("NorthernIrelandAmbulanceService"), new OpenApiString("IsleOfWightAmbulanceService")] }, Required = false, Description = "The type of NHS trust to filter by.", });
                return o;
            });
