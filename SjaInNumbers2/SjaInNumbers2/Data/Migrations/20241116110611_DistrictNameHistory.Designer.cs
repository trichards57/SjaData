...
namespace SjaData.Server.Migrations
{
    ...
    [Migration("20241116110611_DistrictNameHistory")]
    partial class DistrictNameHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SjaInNumbers.Server.Data.Deployment", b =>
                {
                    ...
                    b.Property<int>("AllWheelDriveAmbulances")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("OffRoadAmbulances")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("SjaInNumbers.Server.Data.DistrictPreviousName", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("DistrictPreviousName");
                });
            ...
            modelBuilder.Entity("SjaInNumbers.Server.Data.Person", b =>
                {
                    b.HasOne("SjaInNumbers.Server.Data.Hub", "Hub")
                        .WithMany("People")
                        .HasForeignKey("HubId");
