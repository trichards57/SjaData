...
public partial class DeploymentsController(IDistrictsService districtService, IDeploymentService deploymentService, IMapper mapper, ILogger<DeploymentsController> logger) : ControllerBase
{
    ...
    {
        LogRequestedNationalSummary();

        return await deploymentService.GetNationalSummaryAsync();
    }
    ...
    {
        LogRequestedPeakLoads();

        return deploymentService.GetPeakLoadsAsync();
    }
    ...
    [LoggerMessage(1003, LogLevel.Information, "Requested the national summary.")]
    private partial void LogRequestedNationalSummary();

    [LoggerMessage(1002, LogLevel.Information, "Requested the peak loads.")]
    private partial void LogRequestedPeakLoads();
}
